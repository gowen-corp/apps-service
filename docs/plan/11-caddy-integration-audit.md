...
### 1. Аудит кода Caddy integration
...
- #13 (AttributeError в deployments.py) — может влиять на деплой после изменений
- #16 (login endpoint) — не связано напрямую
